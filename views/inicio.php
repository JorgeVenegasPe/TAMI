    ...
    <main class="main__inicio">
        ...
        <section class="productos" id="productos">
            <figure class="productos__img">
                <img class="vid__item" src="../public/images/catalogo_productos/Soldadora-SPARK-3.png" autoplay="autoplay" muted="muted" loop="loop"></img>
                <p class="nombre_producto">Trabajo</p>
            </figure>
            <figure class="productos__img">
                <img class="vid__item" src="../public/images/catalogo_productos/embalaje2.png" autoplay="autoplay" muted="muted" loop="loop"></img>
                <p class="nombre_producto">Decoraciones</p>
            </figure>
            <figure class="productos__img">
                <img class="vid__item" src="../public/images/catalogo_productos/sellador_vasos2.png" autoplay="autoplay" muted="muted" loop="loop"></img>
